...
class TranslationClient:
    ...
    def translate(self, text: str) -> tuple[str, float]:
        ...
        try:
            ...
            logger.info(
                "Full OpenRouter Response for %s: %r", self.model_name, completion
            )

            if not completion.choices:
                logger.warning(
                    "OpenRouter response for %s had no choices.", self.model_name
                )
            ...
            logger.exception(
                "OpenRouter translation failed for %s: %s", self.model_name, e
            )
