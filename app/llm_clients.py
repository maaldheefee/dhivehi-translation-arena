...
class TranslationClient:
    ...
    def translate(self, text: str) -> tuple[str, float]:
        ...
        try:
            ...
            input_tokens = usage.prompt_tokens if usage and usage.prompt_tokens is not None else len(text) / 4
            output_tokens = (
                usage.completion_tokens if usage and usage.completion_tokens is not None else len(translation) / 4
            )
